...
import { useGetGreyYarnPoDeatilsByIdQuery, } from '../../redux/services/greyYarnPo'
...
import { useGetDyedFabricPoDetailsByIdQuery, useGetDyedFabricPoQuery, useUpdateStatusMutation } from '../../redux/services/dyedFabricPo';
const ToDeliveryReport = ({ selectedPos, setSelectedPos, setForm, }) => {
  ...
  const { data } = useGetDyedFabricPoQuery({ params: { gtCompMastId, isAccepted: true, deliveryFilter: true } })
  ...
  const { data: poDetailsData } = useGetDyedFabricPoDetailsByIdQuery({ poNo: po }, { skip: !po })
    ...
    <div className=" font-roboto  ">
      ...
      <div className='overflow-x-scroll'>
        <table className=" border text-xs overflow-x-scroll w-screen ">
          ...
          <tbody className=''>{console.log(data?.data,"daaaaa")}
                          ...
                          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                            ...
                            <div className=" p-1 ">
                              <>
                                ...
                                <table className=" border text-xs table-auto ">
                                  <thead className='text-white'>
                                    <tr className="bg-orange-600 border-b text-white">
                                      ...
                                      </th> <th className=" border-r cursor-pointer text-m  text-gray-500">
                                        <div className="flex items-center justify-center text-white  ">
                                          <h3>F.dia</h3>
                                      ...
                                      <th className=" border cursor-pointer   text-gray-500">
                                        <div className="">
                                          No Of Rolls
                                  ...
                                  <tbody className=' even:bg-white odd:bg-orange-100'>{console.log(poDetails,"poDetails")}
                                    {(poDetails).map((item, index) => (
                                      <tr className={index % 2 === 0 ? '' : 'bg-orange-100'} key={index}>

                                        <td className="py-2 border-r ">{item.fabric}</td>
                                        ...
                                        <td className="pl-2 
                                        text-end pr-1 py-2">{item.roll}</td>
...
export default ToDeliveryReport