...
import { useGetGreyYarnPoQuery, useUpdateStatusMutation, useGetGreyYarnPoDeatilsByIdQuery, } from '../../redux/services/greyYarnPo'
...
const GreyYarnBill = ({ selectedPos, setSelectedPos, setForm }) => {
  ...
  const { data } = useGetGreyYarnPoQuery({ params: { gtCompMastId, billEntryFilter: true, isAccepted: true } })
  ...
  const { data: poDetailsData } = useGetGreyYarnPoDeatilsByIdQuery({ poNo: po }, { skip: !po })
    ...
    <div class=" font-roboto p-1  ">
      <div className='flex justify-between'>
        <div className='flex items-center'>
          ...
          <div className=''>  <button className={`${selectedPos.length !== 0

            ? 'bg-green-400 hover:bg-green-700'
            : 'bg-gray-500 hover:bg-orange-700'
            } text-white  rounded text-xs p-1`} onClick={handleSubmit
            }  >pay bills</button></div>
        </div>
            ...
            <tr class="bg-orange-600 border-b text-white">
              ...
              <th class=" flex items-center justify-center text-center border-r cursor-pointer text-m  text-gray-500">
                <div class=" text-white w-14">
                  <h3 className=''>Expected Delivery Date</h3>
              ...
              <>
                ...
                >
                  <td
                    ...
                    className="pl-1 py-1  whitespace-nowrap text-xs  text-center text-black-500 border-r-grey ">
                  ...
                  {/* <td className="  text-xs  text-center text-black-500   ">
                    {(item.billEntryFilter? <Tooltip placement="top" title="Accepted"> <button> <GiCheckMark className='text-xl text-green-500' /></button> </Tooltip> : <Tooltip placement="top" title="Not Accepted"> <button ><FaCircleXmark className='hover:text-green-500 text-xl' onClick={() => handleStatus(item.poNo)} /></button> </Tooltip>)}
                  </td> */}
...
//     // You can now use the captured image source for further processing.
