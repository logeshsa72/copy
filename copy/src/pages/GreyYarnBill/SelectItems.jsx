...
const SelectItems = ({ selectedPos, invoiceDetails, setInvoiceDetails, onModalClose }) => {
    ...
    function selectPo(poItem) {
        setInvoiceDetails(prev => [...prev, { ...poItem, billQty: poItem.aDelQty }])
    }
    ...
    const { data: poItems } = useGetGreyYarnPoItemsQuery({ filterPoList: JSON.stringify(selectedPos) }, { skip: selectedPos.length === 0 })
