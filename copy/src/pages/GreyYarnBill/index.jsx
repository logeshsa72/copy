...
const Bill = () => {
  ...
  const { refetch } = useGetGreyYarnPoQuery({ params: { gtCompMastId, billEntryFilter: true, isAccepted: true } })
  ...
  return (
    <div className='border-solid border-2 border-gray-300'>
      ...
      <div className='flex justify-between   border-solid border-2 border-gray-300 m-1'>
        <div>
          <h1 className='text-xl p--1   bg-clip-text text-orange-600 '>Grey Yarn Invoice</h1>
        </div>
