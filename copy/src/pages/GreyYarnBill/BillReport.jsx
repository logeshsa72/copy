...
import { useGetGreyYarnPoBillEntryQuery } from '../../redux/services/greyYarnBillEntry';
...
const AlreadyPaidBills = ({ setDocNo }) => {
  ...
  const { data: yarnPoInvoiceData, refetch } = useGetGreyYarnPoBillEntryQuery({ params: { gtCompMastId } })
