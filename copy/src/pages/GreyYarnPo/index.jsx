...
const GreyYarnPo = () => {
  ...
  const { data, refetch, isLoading, isFetching } = useGetGreyYarnPoQuery({ params: { gtCompMastId, isAccepted: showAcceptedPo } })
  ...
  return (
    <div class="font-roboto  border-solid border-2 border-gray-300  ">
      <div className='flex justify-between items-center m-1   border-solid border-2 border-gray-300 '>
        <h1 className='text-xl text-orange-600 '>YARN PURCHASE ORDER</h1>
