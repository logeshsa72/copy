...
const GreyYarnBill = ({ selectedPos, setSelectedPos, setForm }) => {
  ...
  const { data } = useGetDyedYarnPoQuery({ params: { gtCompMastId, billEntryFilter: true, isAccepted: true } })
  ...
  const { data: poDetailsData } = useGetdyedYarnPoDeatilsByIdQuery({ poNo: po }, { skip: !po })
              ...
              <>
                ...
                >
                  ...
                  <td className="px-1  whitespace-nowrap text-xs  text-left text-black ">
                    {getMonthValue(item.dueDate)}
                  </td>

                  <td className="px--1  whitespace-nowrap text-xs  text-left text-black">
                    {calculateDaysBetween(item.poDate, item.dueDate)}
                  </td>
